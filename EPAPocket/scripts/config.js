...
Config.Text_NoRowSelected = 'موردی انتخاب نشده است';
Config.Text_NoFlightSelected = 'No Flight(s) Selected';
Config.Text_NoSarfaslSelected = 'هیچ سرفصلی انتخاب نشده است';
Config.Text_DeleteConfirm = 'ردیف انتخاب شده حذف خواهد شد. آیا مطمئنید؟';
...
Config.Text_FillRequired = 'لطفا مقدار فیلدهای اجباری را مشخص کنید';
Config.Text_SavedOk = 'تغییرات با موفقیت ذخیره شد';
