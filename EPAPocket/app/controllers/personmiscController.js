...
app.controller('personmiscController', ['$scope', '$location', '$routeParams', '$rootScope', 'personService', 'authService', '$route', function ($scope, $location, $routeParams, $rootScope, personService, authService, $route) {
    ...
    $scope.dg_columns_authors = [
        ...
        { dataField: 'Name', caption: 'نام', allowResizing: true, alignment: 'right', dataType: 'string', allowEditing: false, width: 300 },
        { dataField: 'Website', caption: 'وب سایت', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 250 },
        { dataField: 'Email', caption: 'ایمیل', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 250 },
        { dataField: 'LinkedIn', caption: 'لینکداین', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 200 },
        { dataField: 'Telegram', caption: 'تلگرام', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 200 },
        { dataField: 'Instagram', caption: 'اینستاگرام', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 200 },
        { dataField: 'Tel', caption: 'تلفن', allowResizing: true, alignment: 'center', dataType: 'string', allowEditing: false, width: 150 },
